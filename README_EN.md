...
|---|---:|---|---|
| <img src="assets/README/icons/overview.svg" width="20" alt=""> Agent Engineering | 10 | `skills/01-agent-engineering/` | Agent building, debugging, autonomy loops, skill creation, GPT-6 Pro plan review, adaptive quality gates, adversarial verification, and skill lifecycle management. |
...
| <img src="assets/README/icons/format.svg" width="20" alt=""> Media and Content | 25 | `skills/07-media-content/` | PPT, PDF, DOCX, XLSX, images, video, WeChat articles, and presentation content. |
| <img src="assets/README/icons/writing.svg" width="20" alt=""> Writing and Marketing | 5 | `skills/08-writing-marketing/` | Style imitation, marketing writing, and structured content for distribution. |
| <img src="assets/README/icons/source-index.svg" width="20" alt=""> Business and Industry | 7 | `skills/10-business-industry/` | Healthcare, legal, finance, market sizing, citation verification, and industry report workflows. |
