...
/**
 * PubMed Search via Valyu API
 * Full-text search across PubMed with semantic search capabilities
 */
...
(async () => {
  ...
  if (command === 'setup') {
    ...
    if (!query) {
      ...
      result = await searchPubMed(query, maxResults);
    }
  }
