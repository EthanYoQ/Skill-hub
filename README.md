...
| 类别 | 数量 | 目录 | 适合查什么 |
|---|---:|---|---|
| <img src="assets/README/icons/overview.svg" width="20" alt=""> Agent 工程 | 10 | `skills/01-agent-engineering/` | Agent 构建、调试、自治循环、技能创建、Sol Pro 方案审查、质量门、skill 生命周期，以及 Windows 磁盘/项目垃圾与内存健康维护。 |
